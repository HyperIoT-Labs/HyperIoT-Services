...
/**
 * 
 * @author Aristide Cittadino Interface component for Services System Service.
 *
 */
@RunWith(PaxExam.class)
@ExamReactorStrategy(PerSuite.class)
@FixMethodOrder(MethodSorters.NAME_ASCENDING)
public class HyperIoTServicesTest extends KarafTestSupport {
	...
	public void hyperIoTFrameworkShouldBeInstalled() throws Exception {
		...
		String list = executeCommand("bundle:list");
		System.out.println(list);
		//String classes = executeCommand("bundle:classes 452");
