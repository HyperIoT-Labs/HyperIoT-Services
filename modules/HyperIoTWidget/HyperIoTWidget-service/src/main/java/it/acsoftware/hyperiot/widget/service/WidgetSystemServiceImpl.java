...
public final class WidgetSystemServiceImpl extends HyperIoTBaseEntitySystemServiceImpl<Widget> implements WidgetSystemApi {
    ...
    private void createBasicWidgets() {
        this.createWidgetIfNotExists("Raw data logger", "Shows real time raw data.", WidgetUtils.eventsLogImg, WidgetUtils.eventsLogPreView, 2, 2, "events-log", "{}", WidgetCategory.TABLES, null, false, true);
        ...
        this.createWidgetIfNotExists("Line chart", "Widget to show single or combined realtime data with a line chart representation.", WidgetUtils.realtimeLineChartImg, WidgetUtils.realtimeLineChartPreView, 2, 3, "time-chart", "{\"data\":[]}", WidgetCategory.LINE, null, false, true);
        this.createWidgetIfNotExists("Fourier transform sine Waves", "Widget to show Fast Fourier Transform sine waves.", WidgetUtils.realtimeFftChartImg, WidgetUtils.realtimeFftChartPreView, 2, 3, "fourier-chart", "{\"data\":[]}", WidgetCategory.LINE, null, false, true);
        ...
        this.createWidgetIfNotExists("Statistics output table", "This widget displays output values of algorithms in tabular format.", WidgetUtils.algorithmDataTableImg, WidgetUtils.algorithmDataTablePreView, 3, 3, "algorithm-offline-table", "{}", WidgetCategory.TABLES, null, true, false);
        ...
        this.createWidgetIfNotExists("ECG trace - 3 Chan.", "Show ECG trace chart (3 channels).", WidgetUtils.ecgImg, WidgetUtils.ecgPreView, 6, 6, "ecg", "{}", WidgetCategory.LINE, null, true, true);
