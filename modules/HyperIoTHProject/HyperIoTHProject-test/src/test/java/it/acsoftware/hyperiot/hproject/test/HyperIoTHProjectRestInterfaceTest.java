...
public class HyperIoTHProjectRestInterfaceTest extends KarafTestSupport {
    ...
    *
    ...
    private List<String> hPacketExpectedProperties(){
        ...
        hPacketExpectedProperties.add("categoryIds");
        hPacketExpectedProperties.add("tagIds");
    ...
    private List<String> hPacketsFieldsReferenceInsideHPacketEntityExpectedProperties(){
        ...
        hPacketsFieldsReferenceInsideHPacketEntityExpectedProperties.add("tagIds");
        hPacketsFieldsReferenceInsideHPacketEntityExpectedProperties.add("categoryIds");
