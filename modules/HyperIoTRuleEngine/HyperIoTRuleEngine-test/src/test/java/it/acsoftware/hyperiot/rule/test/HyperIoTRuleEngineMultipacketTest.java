...
public class HyperIoTRuleEngineMultipacketTest extends KarafTestSupport {
    ...
    public void test01_checkMultiPacketRuleShouldWork() {
		...
		engine.check(packet2);
        field1.setValue(24.00);
        engine.check(packet1);  // here rule is satisfied and actions will be applied
    ...
    public void test02_checkMultiPacketRuleSendMailShouldWork() {
        ...
        field1.setValue(24.00);
        engine.check(packet1);  // here rule is satisfied and actions will be applied
        engine.check(packet1);  // rule is satisfied again, but not fired
        field1.setValue(20.00);
        engine.check(packet1);  // rule is not satisfied anymore
        field1.setValue(24.00);
        engine.check(packet1);  // rule is satisfied, fire it
        engine.disposeSession();
    }
