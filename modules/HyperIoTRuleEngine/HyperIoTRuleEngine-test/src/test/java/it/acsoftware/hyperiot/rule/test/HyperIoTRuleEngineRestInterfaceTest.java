...
public class HyperIoTRuleEngineRestInterfaceTest extends KarafTestSupport {
    ...
    *
    ...
    private Rule createRule(HProject hproject, HPacket hpacket) {
        ...
        if (hpacket != null) {
            Assert.assertEquals(hpacket.getDevice().getProject().getId(), ((it.acsoftware.hyperiot.rule.model.Rule) restResponse.getEntity()).getPacket().getDevice().getProject().getId());
