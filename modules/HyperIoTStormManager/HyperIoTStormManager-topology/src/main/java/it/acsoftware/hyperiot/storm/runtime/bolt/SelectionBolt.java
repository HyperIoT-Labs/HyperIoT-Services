...
public class SelectionBolt extends BaseRichBolt {
    ...
    public void declareOutputFields(OutputFieldsDeclarer declarer) {
        ...
        declarer.declareStream(String.format(AVRO_HPROJECT_STREAM_ID_PREFIX, hprojectId), new Fields(StormConstants.ROWKEY_FIELD, StormConstants.HPACKET_ID_FIELD, StormConstants.AVRO_HPACKET_FIELD));
    ...
    public void execute(Tuple input) {
        ...
        try {
            ...
            sendToHBase(avroHPacket, packet.getId(), modelType, timestamp , rowKeyBeginning, input);
    ...
    private void sendToHBase(String avroHPacket, long packetId, ModelType modelType, long timestamp, String rowKeyBeginning,  Tuple input) throws IOException {
        ...
        if (modelType.equals(ModelType.HPACKET)) {
            ...
            collector.emit(streamId, new Values(timestamp, packetId, avroHPacket));
